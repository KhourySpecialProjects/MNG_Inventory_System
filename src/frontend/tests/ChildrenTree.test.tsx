...
import ChildrenTree from "../src/components/ChildrenTree";
...
describe("ChildrenTree", () => {
  ...
  it("returns null when editedProduct is null", () => {
    const { container } = renderWithRouter(
      <ChildrenTree editedProduct={null} teamId={teamId} />
    );
  ...
  it("returns null when children is undefined", () => {
    const { container } = renderWithRouter(
      <ChildrenTree editedProduct={{}} teamId={teamId} />
    );
  ...
  it("renders all child items with correct names", () => {
    const productWithChildren = {
      children: [
        ...
        { itemId: "child-2", name: "Scissors", actualName: "Medical Scissors", status: "Incomplete" },
      ],
    };
      ...
      children: [
        {
          ...
          children: [
            { itemId: "grandchild-1", name: "Item", actualName: "Deep Item" },
          ],
        },
      ],
    };
  ...
  it("does not show expand button for children without sub-children", () => {
    const productNoNesting = {
      children: [
        { itemId: "child-1", name: "Item 1", actualName: "Child 1", children: [] },
      ],
    };
      ...
      children: [
        {
          ...
          name: "Sub Kit",
          children: [
            { itemId: "grandchild-1", name: "Deep Item", actualName: "Item 1" },
          ],
        },
      ],
    };
      ...
      children: [
        {
          ...
          name: "Sub Kit",
          children: [
            { itemId: "grandchild-1", name: "Deep Item" },
          ],
        },
      ],
    };
              ...
              children: [
                {
                  ...
                  name: "Level 3",
                  children: [
                    { itemId: "l4", name: "Level 4", children: [] },
                  ],
                },
              ],
            },
      ...
      children: [
        {
          ...
          name: "Level 1",
          children: [
            { itemId: "grandchild-1", name: "Level 2", children: [] },
          ],
        },
      ],
    };
  ...
  it("uses fallback to name when actualName is missing", () => {
    const productWithChildren = {
      children: [
        { itemId: "child-1", name: "Item Name Only", actualName: undefined },
      ],
    };
  ...
  it("handles children without status field", () => {
    const productWithChildren = {
      children: [
        { itemId: "child-1", name: "Item 1", actualName: "Child 1" },
      ],
    };
