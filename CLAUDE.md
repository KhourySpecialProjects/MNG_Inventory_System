...
# Local Development Commands (No AWS Required)
docker compose build     # Build the DynamoDB docker container
docker compose up        # Start the DynamoDB docker container
docker compose down      # Stop the DynamoDB docker container
npm run seed             # Seed the DynamoDB database in docker
